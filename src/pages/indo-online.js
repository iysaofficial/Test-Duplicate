...
function IndonesiaOnline() {
  ...
  useEffect(() => {
    ...
    if (!termsAccepted) {
      ...
      router.push("/homeindo"); // Navigasi ke halaman HomeIndo
    }
  }, [router]);

  const scriptURL =
    "https://script.google.com/macros/s/AKfycbyRPTfp6ms2r5CWgcTqqahS5xBLnPEpM1zXSfTy73a1mrN-aGd5AWnMHpxSLeDdnAkIGA/exec";
