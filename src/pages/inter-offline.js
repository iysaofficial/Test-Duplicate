...
export default function InternationalOffline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Bali International Science Fair - Offline Competition":
        break;
      case "Bali International Science Fair - Offline Competition + Full Package":
        break;
      default:
        break;
    }
  ...
  useEffect(() => {
    ...
    if (!termsAccepted) {
      ...
      router.push("/homeinter"); // Navigasi ke halaman HomeIndo
    }
  }, [router]);

  const scriptURL =
    "https://script.google.com/macros/s/AKfycbw6XDBoQbdsZP1-OJVxAdw-TmHyTY5L9lCFR5cAKHfx-GrIZPWp8qSY-TcsA7XYtZfvlg/exec";
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          router.push({
            pathname: "/thankyouinter",
            query: formData, // Kirim data lewat query
          });
        }, 1000);
      } else {
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Bali International Science Fair - Offline Competition + Full Package">
